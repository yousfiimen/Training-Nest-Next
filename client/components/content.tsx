import image from "@/assets/images/socialMedia.jpg";
...
export default function () {
  return (
    <>
      <div className="flex flex-wrap justify-center mt-5 p-5">
        {/* Premier bloc avec un paragraphe */}
        ...
        {/* Deuxième bloc avec une image */}
        <div className="w-full md:w-1/2 p-4">
          <Image src={image} alt="Picture of the authssor" />
        </div>
      </div>

      <div className="mb-5 text-center">
        <h3 className="text-2xl font-semibold leading-none tracking-tight">Our Services</h3>
      </div>
